...
# 0 "" 2
# arch/x86/kernel/asm-offsets_32.c:21: 	OFFSET(CPUINFO_x86_mask, cpuinfo_x86, x86_mask);
# 21 "arch/x86/kernel/asm-offsets_32.c" 1
	
.ascii "->CPUINFO_x86_mask $3 offsetof(struct cpuinfo_x86, x86_mask)"	#
# 0 "" 2
...
.ascii "->CPUINFO_x86_vendor_id $92 offsetof(struct cpuinfo_x86, x86_vendor_id)"	#
# 0 "" 2
...
.ascii "->TSS_sysenter_sp0 $3844 offsetof(struct cpu_entry_area, tss.x86_tss.sp0) - offsetofend(struct cpu_entry_area, entry_stack_page.stack)"	#
# 0 "" 2
...
.ascii "->TASK_threadsp $988 offsetof(struct task_struct, thread.sp)"	#
# 0 "" 2
...
.ascii "->TASK_addr_limit $1060 offsetof(struct task_struct, thread.addr_limit)"	#
# 0 "" 2
...
.ascii "->TLB_STATE_user_pcid_flush_mask $10 offsetof(struct tlb_state, user_pcid_flush_mask)"	#
# 0 "" 2
