...
#define CPUINFO_x86_vendor_id 92 /* offsetof(struct cpuinfo_x86, x86_vendor_id) */
...
#define TSS_sysenter_sp0 3844 /* offsetof(struct cpu_entry_area, tss.x86_tss.sp0) - offsetofend(struct cpu_entry_area, entry_stack_page.stack) */

#define __NR_syscall_max 387 /* sizeof(syscalls) - 1 */
#define NR_syscalls 388 /* sizeof(syscalls) */

#define TASK_threadsp 988 /* offsetof(struct task_struct, thread.sp) */

#define TASK_TI_flags 0 /* offsetof(struct task_struct, thread_info.flags) */
#define TASK_addr_limit 1060 /* offsetof(struct task_struct, thread.addr_limit) */
...
#define TLB_STATE_user_pcid_flush_mask 10 /* offsetof(struct tlb_state, user_pcid_flush_mask) */
